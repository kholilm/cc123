                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/assets/templated/dist/img/caraosel1.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/assets/templated/dist/img/caraosel2.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/assets/templated/dist/img/caraosel3.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
                    ...
                    <section class="col-lg-6 connectedSortable">
                        <div class="col">
                            <div class="card shadow">
                                <div class="inner">
                                    <img src="/assets/templated/dist/img/testes.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
